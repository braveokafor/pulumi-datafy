...
const (
	...
	mainPkg = "datafy"
	// modules:
	mainMod = "index" // the datafy module
)

//go:embed cmd/pulumi-resource-datafy/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-datafy/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-datafy/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "datafy", datafy.Provider(),
		...
		// convention is to have a function at "github.com/datafy-io/terraform-provider-datafy/provider".New
		...
		LogoURL: "https://www.datafy.com/_next/static/media/datafyWhite.50dd47a1.svg",
		// PluginDownloadURL is an optional URL used to download the Provider
		// for use in Pulumi programs
		// e.g. https://github.com/org/pulumi-provider-name/releases/download/v${VERSION}/
		PluginDownloadURL: "",
		Description:       "A Pulumi package for creating and managing datafy cloud resources.",
		// category/cloud tag helps with categorizing the package in the Pulumi Registry.
		// For all available categories, see `Keywords` in
		// https://www.pulumi.com/docs/guides/pulumi-packages/schema/#package.
		Keywords:   []string{"datafy", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://www.pulumi.com",
		Repository: "https://github.com/braveokafor/pulumi-datafy",
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/braveokafor/pulumi-datafy/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("datafy_", mainMod,
